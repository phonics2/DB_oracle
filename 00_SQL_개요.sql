...
이외 여러가지 권한 있음 권한을 여러가지 한 번에 작성할 때는 ,(콤마) 사용해서 작성.            
TO 
아이디명; : 어떤 아이디 권한을 줄 것인지 설정
*/
...
/*
 테이블을 생성하기
 테이블이란 ? 데이터베이스 모든 데이터를 포함한 공간
    테이블명 : 중점이되어 중점과 관련된 내용을 설정할 수 있도록 작성
    
생성하는 방법
CREATE TABLE 테이블병 (컬럼명 데이터타입);
*/
...
작성 방법
INSERT INTO 
테이블명 (컬럼명1,            컬럼명2,          컬럼명3, ..).VALUES
     (컬럼에해당하는값1, 컬럼에해당하는값2, 컬럼에해당하는값3 ...);
*/
...
INSERT INTO MEMBER (M_ID,M_NAME,M_AGE,M_PHONE,M_DATE) VALUES (6,'정수진','33','1234567895','2024-05-05');
