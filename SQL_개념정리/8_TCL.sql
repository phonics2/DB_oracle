...
-------------> 커밋이 완료된 시점으로 돌아감 초기 상태로 돌아가길 원하면 그지점에  COMMIT을 해야함

SELECT * FROM DEPARTMENT3; -- ROLLBACK 확인
