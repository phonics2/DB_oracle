...
-- 1) 서브쿼리 전 직원의 평균 급여 구하기
SELECT FLOOR(AVG(SALARY))
FROM EMPLOYEE;

-- 2) 메인쿼리 직원들 중 급여가 3000000원 이상인 사원들의
--- 사번, 이름, 직급코드, 급여 조회
...
위 코드의 문제점 : 각 직급별 개별적인 평균급여는 반환하지 않음
만약에 각 직급별로 평균 급여를 정확하게 계산하고 개별적인 평균급여도 반환하길 원한다면
