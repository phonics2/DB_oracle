...
'
예를 들어 회원가입 아이디 이름 이메일 번호 주소 -> 널이 아님 체크
...
VALUES (2,'빠나쁘레쏘','서울시 강남구 력삼동','02-5555-5555','영업시간 12:00 ~ 14:00');
...
-- 7 탐엔탐스 서울시 동대문구 장안동 02-5555-6666 영업시간 10:00 ~ 22:00
INSERT INTO kh_cafe(c_id,c_name,c_address,c_phone,c_time)
VALUES (7,'탐엔탐스','서울시 동대문구 장안동','02-5555-6666','영업시간 : 평일 10:00 ~ 22:00');

-- 8 이디야커피 서울시 송파구 잠실동 02-1234-5678 영업시간 9:00 ~ 21:00
INSERT INTO kh_cafe(c_id,c_name,c_address,c_phone,c_time)
VALUES (8,'이디야커피','서울시 송파구 잠실동','02-1234-5678','영업시간 : 평일 10:00 ~ 13:00');
...
SELECT : 저장된 데이터를 볼 때 사용
 -> 로그인, 게시판 글가져오기, 회원정보
    급여내역, 스터디명단블로그 등
SELECT 어떤칼럼을볼지선택 FORM 어느테이블에서가져올지테이블명작성
